...
public sealed partial class SmoteModelTrainer
{
    ...
    /// </summary>
    private static SmoteDriftArtifact ComputeSmoteDriftDiagnostics(
    ...
    private static void SanitizeSmoteSnapshotArrays(ModelSnapshot snapshot)
    {
    ...
    private static double SafeSmote(double v, double fallback = 0.0)
    ...
    private static double[] ComputeFeatureVariancesSmote(List<TrainingSample> trainSet, int F)
    {
    ...
    /// <summary>
    /// Builds a <see cref="SmoteWarmStartArtifact"/> summarising the warm-start
    /// outcome for this training run.
    /// </summary>
    private static SmoteWarmStartArtifact BuildSmoteWarmStartArtifact(
        bool     attempted,
        bool     compatible,
        ...
        string[] issues)
    {
        return new SmoteWarmStartArtifact
        {
            Attempted            = attempted,
